...
| ignored\_channels | Channels that are ignored from being eligible to post to the starboard | list | empty |
| sources | Channels that are eligible to post to the starboard | list | empty |
